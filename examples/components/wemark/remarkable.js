      ...
      3: [
        function (e, t, r) {
          ...
          var s = /[a-zA-Z_:][a-zA-Z0-9:._-]*/,
            ...
            i = /'[^']*'/,
            l = /"[^"]*"/,
            a = n(/(?:unquoted|single_quoted|double_quoted)/)('unquoted', o)(
              'single_quoted',
              i
            )('double_quoted', l)(),
            c = n(/(?:\s+attr_name(?:\s*=\s*attr_value)?)/)('attr_name', s)(
              'attr_value',
              a
            )(),
            ...
            )('open_tag', u)('close_tag', p)('comment', h)('processing', f)(
              'declaration',
              d
            )('cdata', g)();
      ...
      20: [
        function (e, t, r) {
          ...
          (a.blockquote_open = function () {
            ...
            (a.code = function (e, t) {
              return e[t].block
                ? '<pre><code>' + l(e[t].content) + '</code></pre>' + c(e, t)
                : '<code>' + l(e[t].content) + '</code>';
            }),
            (a.fence = function (e, t, r, n, a) {
              ...
              if (h.params) {
                if (
                  ((u = h.params.split(/\s+/g)[0]), s(a.rules.fence_custom, u))
                )
                  return a.rules.fence_custom[u](e, t, r, n, a);
                (g = l(i(o(u)))), (f = ' class="' + d + g + '"');
              }
              return (
                (p = r.highlight
                  ? r.highlight(h.content, g) || l(h.content)
                  : l(h.content)),
                '<pre><code' + f + '>' + p + '</code></pre>' + c(e, t)
              );
            }),
            (a.fence_custom = {}),
        ...
        function (e, t, r) {
          ...
          t.exports = function (e, t, r, s) {
            ...
            for (p = [], a = 0; a < u.length; a++) {
              ...
              if (!/^:?-+:?$/.test(h)) return !1;
              58 === h.charCodeAt(h.length - 1)
                ? p.push(58 === h.charCodeAt(0) ? 'center' : 'right')
                : 58 === h.charCodeAt(0)
                ? p.push('left')
                : p.push('');
            }
        ...
        function (e, t, r) {
          ...
          function n(e, t, r, n) {
            ...
            return (
              ...
              0 === p.length
                ? -1
                : (n.abbreviations || (n.abbreviations = {}),
                  'undefined' == typeof n.abbreviations[':' + u] &&
                    (n.abbreviations[':' + u] = p),
                  a)
            );
          }
              ...
              for (t = 1, r = i.length - 1; r > t; t++)
                if (
                  ...
                  for (
                    s = i[t].content;
                    s.length &&
                    ((o = n(s, e.inline, e.options, e.env)), !(0 > o));
          ...
          t.exports = function (e) {
            ...
            if (e.options.linkify)
              for (r = 0, i = v.length; i > r; r++)
                if ('inline' === v[r].type)
                  for (a = v[r].children, g = 0, t = a.length - 1; t >= 0; t--)
                    if (((c = a[t]), 'link_close' !== c.type)) {
                      if (
                        ('htmltag' === c.type &&
                          (n(c.content) && g > 0 && g--, s(c.content) && g++),
                        !(g > 0) && 'text' === c.type && l.test(c.content))
                      ) {
                        if (
                          (k || ((k = o()), (m = k.links), (b = k.autolinker)),
                          (u = c.content),
                          (m.length = 0),
                          b.link(u),
                          !m.length)
        ...
        function (e, t, r) {
          ...
          function n(e, t, r, n) {
            ...
            return h > p && 10 !== c.src.charCodeAt(p)
              ? -1
              : ((b = a(e.slice(1, u))),
                'undefined' == typeof n.references[b] &&
                  (n.references[b] = { title: m, href: g }),
                p);
          }
          var s = e('../rules_inline/state_inline'),
            o = e('../helpers/parse_link_label'),
      ...
      46: [
        function (e, t, r) {
          ...
          t.exports = function (e, t) {
            ...
            if (t) return !1;
            if (((c = s(e, p)), (r = c.delims), !c.can_open))
              return (
                    ...
                    t ||
                      ((c =
                        'x' === u[1][0].toLowerCase()
                          ...
                          : parseInt(u[1], 10)),
                      (e.pending += i(o(c) ? c : 65533))),
                    (e.pos += u[0].length),
                    !0
                  );
              } else if (((u = e.src.slice(p).match(a)), u && s(n, u[1])))
        ...
        function (e, t, r) {
          ...
          '\\!"#$%&\'()*+,./:;<=>?@[]^_`{|}~-'.split('').forEach(function (e) {
            ...
            (t.exports = function (e, t) {
              ...
              if ((s++, o > s)) {
                if (((r = e.src.charCodeAt(s)), 256 > r && 0 !== n[r]))
        ...
        function (e, t, r) {
          ...
          t.exports = function (e, t) {
            ...
            if (((p = l + 1), m > p && 40 === e.src.charCodeAt(p))) {
              ...
              for (
                b = p,
                  s(e, p) ? ((c = e.linkContent), (p = e.pos)) : (c = ''),
                  b = p;
                m > p && ((f = e.src.charCodeAt(p)), 32 === f || 10 === f);
                p++
              );
